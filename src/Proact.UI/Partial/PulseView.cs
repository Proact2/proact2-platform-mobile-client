...
namespace SkiaPulse {
    public class PulseView : SKCanvasView {

        public static readonly BindableProperty PulseColorProperty =
        BindableProperty.Create( nameof( PulseColor ), typeof( Color ), typeof( PulseView ), Color.Red, propertyChanged: OnPropertyChanged );
        public static readonly BindableProperty AutoStartProperty =
        BindableProperty.Create( nameof( AutoStart ), typeof( bool ), typeof( PulseView ), false, propertyChanged: OnPropertyChanged );
        public static readonly BindableProperty SourceProperty =
        BindableProperty.Create( nameof( Source ), typeof( string ), typeof( PulseView ), "", propertyChanged: OnPropertyChanged );
        public static readonly BindableProperty SpeedProperty =
        BindableProperty.Create( nameof( Speed ), typeof( int ), typeof( PulseView ), 10, propertyChanged: OnPropertyChanged );
        ...
        private static void OnPropertyChanged( BindableObject bindable, object oldVal, object newVal ) {
            var pulse = bindable as PulseView;
        ...
        protected override void OnPropertyChanged( [CallerMemberName] string propertyName = null ) {
            ...
            if ( propertyName == nameof( Source ) ) {
                ...
                resourceBitmap = resourceBitmap?.Resize( new SKImageInfo( 124, 182 ), SKFilterQuality.Medium );
            }
        }
        ...
        protected override void OnPaintSurface( SKPaintSurfaceEventArgs args ) {
            ...
            if ( IsRun ) {
                ...
                canvas.DrawCircle( center.X, center.Y, 150, paint );
